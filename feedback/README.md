...
Immediately below the feedback hero, guests can use the bilingual stay-connected panel for the existing public LINE invite, celebration WhatsApp group and `@sunvedatech` Instagram account before entering the form. Keep these destinations public and avoid adding a private phone number to the static page.
